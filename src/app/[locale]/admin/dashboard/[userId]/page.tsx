...
import AdminWhatsAppNotifications from '@/components/admin/WhatsAppNotifications/WhatsAppNotifications';
...
import SoundManager from '@/components/admin/SubscriptionAlert/SoundManager';
import { AutoBackupManager } from '@/components/admin/Backup/AutoBackupManager';
...
const AdminDashboard = ({ params }: { params: Promise<{ userId: string }> }) => {
  ...
  // Additional tabs available from Settings
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {additionalTabs.map((tab) => (
                  <button
                    ...
                    className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 hover:from-red-50 hover:to-orange-50 dark:hover:from-red-900 dark:hover:to-orange-900 border-2 border-gray-200 dark:border-gray-600 hover:border-red-400 dark:hover:border-red-500 rounded-lg p-4 transition-all duration-200 text-right hover:shadow-lg"
                  >
