...
import TrainerMessagesChat from '@/components/trainer/TrainerMessagesChat';
...
const TrainerDashboard = ({ params }: { params: Promise<{ userId: string }> }) => {
  ...
  // Fetch unread messages count for sidebar alert
  useEffect(() => {
    let isMounted = true;
  ...
  const mainTabs = [
    ...
    { id: 'messages', name: 'الرسائل', icon: '✉️', showAlert: unreadMessages > 0 },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full sm:w-auto text-center sm:text-left">
            ...
            <div className="text-center">
              ...
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-green-500 to-gray-600 rounded-full flex items-center justify-center text-white font-bold">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {additionalTabs.map((tab) => (
                  <button
                    ...
                    className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 hover:from-green-50 hover:to-emerald-50 dark:hover:from-green-900 dark:hover:to-emerald-900 border-2 border-gray-200 dark:border-gray-600 hover:border-green-400 dark:hover:border-green-500 rounded-lg p-4 transition-all duration-200 text-right hover:shadow-lg"
                  >
