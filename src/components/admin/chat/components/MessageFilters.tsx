    ...
    <div className="flex flex-col sm:flex-row gap-4 mb-6">
      ...
      <div className="relative">
        ...
        <select
          ...
          className="pl-8 pr-3 py-1 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
        >
